...
export const metadata: Metadata = {
  title: 'Terms',
  description: 'Terms of service and usage guidelines for the Countries / States / Cities API and UI.',
};
    ...
    <main>
      <div className='rounded-2xl border bg-(--surface) p-6 shadow-sm sm:p-10'>
        ...
        <div className='mt-8 space-y-8'>
          <section>
            <h2 className='text-lg font-semibold text-(--text)'>1. Usage</h2>
          ...
          <section>
            <h2 className='text-lg font-semibold text-(--text)'>2. Rate Limiting and Abuse</h2>
            <p className='mt-2 text-sm text-(--text-muted)'>
          ...
          <section>
            <h2 className='text-lg font-semibold text-(--text)'>3. Attribution</h2>
            <p className='mt-2 text-sm text-(--text-muted)'>
              Attribution is recommended when you publish or redistribute the API/product. See the{' '}
              <Link className='underline text-(--text)' href='/docs'>
                Docs
              </Link>{' '}
          ...
          <section>
            <h2 className='text-lg font-semibold text-(--text)'>4. No Warranty</h2>
            <p className='mt-2 text-sm text-(--text-muted)'>
          ...
          <section>
            <h2 className='text-lg font-semibold text-(--text)'>6. Changes</h2>
            <p className='mt-2 text-sm text-(--text-muted)'>
          ...
          <section>
            <h2 className='text-lg font-semibold text-(--text)'>7. Contact</h2>
            <p className='mt-2 text-sm text-(--text-muted)'>
              GitHub:{' '}
              <a

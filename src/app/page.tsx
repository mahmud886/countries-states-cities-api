    ...
    <main>
      <div className='rounded-2xl border border-gray-200/70 bg-white p-6 shadow-sm sm:p-10'>
        <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
          <div>
            <h1 className='text-3xl font-semibold tracking-tight'>Countries, States & Cities</h1>
        ...
        <div className='mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3'>
          ...
          >
            ...
            <div className='mt-1 text-xs text-gray-600'>Browse, search, filter, sort</div>
            <div className='mt-4 text-sm text-gray-900 group-hover:underline'>Open →</div>
          </Link>
          <Link
            className='group rounded-xl border border-gray-200/60 bg-gray-50 p-5 shadow-sm hover:bg-white'
            href='/regions'
          >
            ...
            <div className='mt-1 text-xs text-gray-600'>Browse regions and subregions</div>
            <div className='mt-4 text-sm text-gray-900 group-hover:underline'>Open →</div>
          </Link>
          <Link
            className='group rounded-xl border border-gray-200/60 bg-gray-50 p-5 shadow-sm hover:bg-white'
          ...
          >
            ...
            <div className='mt-1 text-xs text-gray-600'>Filter by country_id</div>
            <div className='mt-4 text-sm text-gray-900 group-hover:underline'>Open →</div>
          </Link>
          <Link
            className='group rounded-xl border border-gray-200/60 bg-gray-50 p-5 shadow-sm hover:bg-white'
          ...
          >
            ...
            <div className='mt-1 text-xs text-gray-600'>Filter by state_id / country_id</div>
            <div className='mt-4 text-sm text-gray-900 group-hover:underline'>Open →</div>
          </Link>
        </div>
        ...
        <div className='mt-8 grid gap-3 sm:grid-cols-2'>
          ...
          <div className='rounded-xl border border-gray-200/60 bg-white p-5 shadow-sm'>
            ...
            <div className='mt-1 text-xs text-gray-600'>Browse endpoints and try them in the browser.</div>
            <div className='mt-4'>

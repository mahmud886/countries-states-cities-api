              ...
              {json.data.length ? (
                json.data.map((c) => (
                  <tr key={c.id} className='border-t border-gray-100 hover:bg-gray-50'>
                    ...
                    <td className='px-4 py-3 text-gray-700'>{c.iso2 ?? '-'}</td>
                    <td className='px-4 py-3 text-gray-700'>{c.capital ?? '-'}</td>
                    <td className='px-4 py-3 text-right font-mono text-xs text-gray-700'>{c.id}</td>
                  </tr>
                ))
              ) : (

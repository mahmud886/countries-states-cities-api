export const openapi = {
  ...
  info: {
    ...
    version: '1.0.0',
    description: 'REST API for countries, states/provinces, and cities backed by Supabase (PostgreSQL).',
  },
  servers: [{ url: '/' }],
  components: {
    schemas: {
    ...
    '/api/regions': {
      get: {
        ...
        parameters: [
          ...
          { in: 'query', name: 'sort', schema: { type: 'string', enum: ['name', 'id'] } },
    ...
    '/api/regions/{id}/countries': {
      get: {
        ...
        parameters: [
          ...
          { in: 'query', name: 'limit', schema: { type: 'integer', default: 20 } },
          { in: 'query', name: 'search', schema: { type: 'string' } },
          { in: 'query', name: 'sort', schema: { type: 'string', enum: ['name', 'id', 'population'] } },
          { in: 'query', name: 'order', schema: { type: 'string', enum: ['asc', 'desc'] } },
        ],
        responses: { 200: { description: 'OK' } },
      },
      ...
      get: {
        ...
        parameters: [
          ...
          { in: 'query', name: 'iso3', schema: { type: 'string' } },
          {
            in: 'query',
            name: 'sort',
            schema: { type: 'string', enum: ['name', 'id', 'iso2', 'iso3', 'population'] },
          },
          { in: 'query', name: 'order', schema: { type: 'string', enum: ['asc', 'desc'] } },
        ],
        responses: {

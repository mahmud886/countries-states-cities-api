                    ...
                    {cIdx === 0 ? (
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <Skeleton
                            className={`h-4 ${pickWidth(rIdx * 7 + cIdx * 3)} max-w-[340px] rounded-full`}
                          />
                          <div className="mt-2">
                            <Skeleton
                              className={`h-3 ${pickWidth(rIdx * 11 + cIdx * 5)} max-w-[220px] rounded-full`}
                            />
                          </div>
                        </div>
                      </div>
                      ...
                      <Skeleton
                        className={`h-4 ${pickWidth(rIdx * 5 + cIdx * 9)} max-w-[220px] rounded-full`}
                      />
                    )}
                  </td>
                ))}

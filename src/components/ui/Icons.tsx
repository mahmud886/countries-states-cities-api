  ...
  switch (name) {
    ...
    case "cities":
      return (
        <svg {...common}>
          <path
            d="M4.5 20V9.2c0-.663.537-1.2 1.2-1.2H10v12H4.5Z"
            stroke="currentColor"
            strokeWidth="1.6"
          />
          <path
            d="M10 20V4.8c0-.663.537-1.2 1.2-1.2H17a2 2 0 0 1 2 2V20H10Z"
            stroke="currentColor"
            strokeWidth="1.6"
          />
          <path
    ...
    case "map":
      return (
        <svg {...common}>
          ...
          />
          <path
            d="M12 10.2a1.6 1.6 0 1 0 0-3.2 1.6 1.6 0 0 0 0 3.2Z"
            fill="currentColor"
          />
        </svg>
      );
    case "focus":
      return (
        <svg {...common}>
          <path
            d="M9 3H5.6C4.7 3 4 3.7 4 4.6V8"
            stroke="currentColor"
            strokeWidth="1.6"
            strokeLinecap="round"
          />
          <path
            d="M15 3h3.4c.9 0 1.6.7 1.6 1.6V8"
            stroke="currentColor"
            strokeWidth="1.6"
            strokeLinecap="round"
          />
          <path
            d="M9 21H5.6c-.9 0-1.6-.7-1.6-1.6V16"
            stroke="currentColor"
            strokeWidth="1.6"
            strokeLinecap="round"
          />
          <path
            d="M15 21h3.4c.9 0 1.6-.7 1.6-1.6V16"
            stroke="currentColor"
            strokeWidth="1.6"
            strokeLinecap="round"
          />
    ...
    case "sparkle":
      return (
        <svg {...common}>
          <path
            d="M12 2l1.3 4.2L18 7.5l-4.1 1.4L12 13l-1.9-4.1L6 7.5l4.7-1.3L12 2Z"
            fill="currentColor"
          />
          <path
